export const en = {
  ...
  album: {
    ...
    uploadSuccess: 'Photo sent. It will appear in the album after admin approval.',
    uploadError: 'Upload failed. Check the token and your connection.',
    eyebrow: 'Album',
    title: 'We are collecting wedding memories in one place.',
    subtitle:
      'Guests can send new photos using the invitation token. Images stay pending until the admin approves them.',
    refreshButton: 'Refresh album',
    refreshLoading: 'Refreshing...',
    uploadTitle: 'Send a photo',
    uploadDescription: 'Enter the invitation token, choose a photo, and add a short caption if you want.',
    ...
    approvedTitle: 'Approved photos',
    approvedEmpty: 'No approved photos yet. The first ones will appear here after moderation.',
  },
  travel: {
  ...
  admin: {
    ...
    hero: {
      eyebrow: 'Admin',
      title: 'RSVP dashboard, photo album, and logistics contacts.',
      subtitle:
        'Here you monitor guests and factions, approve uploaded guest photos, and update the useful contact book for the wedding.',
