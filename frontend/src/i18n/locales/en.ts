export const en = {
  ...
  album: {
    ...
    uploadButtonMultiple: 'Send {{count}} files to the album',
    uploadProgress: 'Uploading {{done}}/{{total}}...',
    uploadSuccessMultiple: '{{count}} files sent and published in the album.',
    uploadPartialError: '{{done}}/{{total}} files sent, some failed.',
    eyebrow: 'Album',
  ...
  admin: {
    ...
    hero: {
      ...
      galleryEyebrowArchive: 'Tactical Archives',
      galleryTitleLead: 'Photo Gallery',
      galleryTitleHighlight: '& Memories',
      gallerySubtitle:
        'Real-time operational control and moderation of guest photo contributions for Davide & Ilaria\'s wedding.',
    },
    stats: {
    ...
    photos: {
      title: 'Gallery',
      statsPhotosLabel: 'Guest Photos',
      statsPhotosSubtitle: 'Synced',
      statsVideosLabel: 'HD Videos',
      statsVideosSubtitle: '4K/1080p clips',
      statsStorageLabel: 'Cloud Storage',
      statsStorageUnit: '/ 100 GB',
      filterAll: 'All ({{count}})',
      searchLabel: 'Filter photos',
      searchPlaceholder: 'Search by guest or caption...',
      liveApprovalLabel: 'Live approval',
      liveApprovalSubtitle: 'Auto-publish to the big screen',
      comingSoon: 'Coming soon',
      zipArchiveButton: 'ZIP archive',
      liveSlideButton: 'Start Live Slide',
      uploadOfficialButton: 'Upload official shots',
      liveBannerTitle: 'Guest Channel Active:',
      liveBannerIntro: 'Instant uploads enabled via the "Operation Pirulini" QR code.',
      liveBannerLastUpload: 'Last upload {{time}} by {{name}}.',
      liveBannerNoUploads: 'Waiting for the first upload.',
      liveBannerTag: 'Realtime Feed • Wall Rose',
      backupBannerTitle: 'Cloud Backup Integrity',
      backupBannerBadge: 'AES-256 Encryption',
      backupBannerBody:
        '{{used}} GB of {{quota}} GB used. Original RAW/HD files are protected and synced in real time with the official photo album and the venue projector.',
      syncLogButton: 'Sync Log',
      ...
      prevPage: 'Previous',
      nextPage: 'Next',
      viewingCount: 'Viewing {{from}}–{{to}} of {{total}} items',
      addPhotoCardLabel: 'Upload a shot',
      addPhotoModalTitle: 'Upload a photo or video',
      favoriteUpdateFailed: 'Could not update the favorite.',
      editButton: 'Edit',
      editModalTitle: 'Edit photo',
      editCaptionPlaceholder: 'Caption',
      editTagPlaceholder: 'Moment (optional)',
      editSave: 'Save',
      editSaving: 'Saving...',
      editFailed: 'Could not save the changes.',
      previousMedia: 'Previous photo',
      nextMedia: 'Next photo',
    },
    contacts: {
      ...
      filterAll: 'All ({{count}})',
      statsActive: 'Active',
      statsActiveSubtitle: '{{percent}}% of suppliers',
      statsInactive: 'Inactive',
      statsInactiveSubtitle: '{{percent}}% of suppliers',
