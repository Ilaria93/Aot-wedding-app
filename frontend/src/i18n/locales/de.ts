export const de = {
  ...
  admin: {
    ...
    photos: {
      ...
      editModalTitle: 'Foto bearbeiten',
      editCaptionPlaceholder: 'Bildunterschrift',
      editTagPlaceholder: 'Moment (optional)',
      editSave: 'Speichern',
      editSaving: 'Speichern...',
      editFailed: 'Änderungen konnten nicht gespeichert werden.',
      previousMedia: 'Vorheriges Foto',
      nextMedia: 'Nächstes Foto',
    },
    contacts: {
