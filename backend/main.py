...
from routes.admin_rsvp_table_route import router as admin_rsvp_table_router
...
app.include_router(admin_rsvp_entries_router)
app.include_router(admin_rsvp_table_router)
