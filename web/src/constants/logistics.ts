...
export function getLogisticsContactCategoryOptions(t: TranslateFn) {
  return LOGISTICS_CONTACT_CATEGORY_IDS.map((id) => ({
    id,
    label: getLogisticsContactCategoryLabel(id, t),
  }));
}
